...
export NGINX_CONF_FILE=$BASE_DIR/conf/nginx_cdn2_t2.conf  # default configuration, replace this with the configuration  specific to the server

sudo chown 999:999 $NGINX_CONF_FILE $CONF_DIR/maintenance.conf  # nginx will be able to read the config changes on the host with id 999 as the file owner
